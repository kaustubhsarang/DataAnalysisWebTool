...
<center>
	<f:view>
			...
			<td width="50%" align="right"><a href="confirm.jsp">Logout</a></td>
				...
				<table>
				<tr><td colspan="2">
				<p align="center"><b>Please Click the "Table" button to view the tables in database</b></p></td></tr>
				<tr>
				<td><p align="center"><b>For Descriptive statistics</b></p></td>
				<td><p align="center"><b>For Regression Analysis</b></p></td>
				</tr>
				<tr>
				<td>
				<p>i)Click the "Columns for Stats" button to view the columns in selected table</p>
				<p>ii)Click the "Descriptive Stats" button to view the report of Descriptive statistics</p>
				</td>
				<td>
				<p>i)Click "Columns for Regression" button</p>
				<p>ii)Click "Regression Report" to generate the report</p>
				<p>iii)Click "Generate Graph" to plot the graph between selected Predicted and Response variables</p>
				</td>
				</tr>
				</table>
				...
				<h:form>
					...
					<div class="left-div">
						<h:panelGrid columns="8">
							...
							<h:commandButton value="Tables" action="#{statsBean.getTables}" styleClass="button" />
							<h:commandButton value="Columns for Stats" action="#{statsBean.getColumnNames}" styleClass="button" disabled="#{statsBean.renderColumnListbutton}" />
							<h:commandButton value="Descriptive Stats" action="#{statsBean.generateReport}" styleClass="button" disabled="#{statsBean.renderReport}" />
							<h:commandButton value="Columns for regression" action="#{statsBean.displayColumnsforRegression}" styleClass="button" />												
							<h:commandButton value="Regression Report" action="#{statsBean.generateRegressionReport}" styleClass="button" disabled="#{statsBean.renderRegressionButton}" />
					...
					<h:outputText value="#{statsBean.tableSelected}"/>
						<panelGrid columns="4">
							<h:selectOneMenu id="selectOneCb"
								style="width:150px; height:20px; align:top"
